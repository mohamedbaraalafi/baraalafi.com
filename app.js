...
const I18N = {
  en: {
    ...
    page_pub_title: "Publications", page_pub_sub: "Peer-reviewed articles, working papers and research notes, in chronological order.",
    page_art_title: "Articles & posts", page_art_sub: "Research notes and contributions aimed at a broader audience.",
    ...
    card3_tag: "03", card3_title: "Applied Public Policy", card3_desc: "Policy evaluation and administrative data, with particular attention to the Maghreb.",
    ...
    art6_date: "October 2025", art6_title: "2026 Finance Law: Public Employment and Fiscal Sustainability",
  ...
  ar: {
    ...
    about_p1: "أنا اقتصادي شاب، أدرس حاليًا الاقتصاد في مدرسة باريس للاقتصاد. تتركز أبحاثي على النمو الاقتصادي والمؤسسات والتنمية، مع اهتمام خاص بالاقتصادات الناشئة.",
    ...
    page_pub_title: "المنشورات", page_pub_sub: "مقالات محكّمة، أوراق عمل، وملاحظات بحثية، مرتبة زمنيًا.",
    page_art_title: "مقالات وتدوينات", page_art_sub: "ملاحظات بحثية ومساهمات موجهة لجمهور أوسع.",
    ...
    card3_tag: "03", card3_title: "السياسات العامة التطبيقية", card3_desc: "تقييم السياسات والبيانات الإدارية، مع اهتمام خاص بمنطقة المغرب العربي.",
    ...
    art6_date: "أكتوبر 2025", art6_title: "قانون المالية التونسي 2026: التشغيل العمومي واستدامة المالية العامة",
