...
const I18N = {
  en: {
    ...
    hero_lead: "Young economics researcher, currently studying at the Paris School of Economics. My work focuses on macroeconomics, institutions, development and public policy.",
    hero_cta_1: "View my research", hero_cta_2: "Get in touch",
    ...
    stat_1: "Research & working papers", stat_2: "Published articles", stat_3: "Years of research", stat_4: "Languages spoken",
    ...
    card2_tag: "02", card2_title: "Applied Econometrics & Policy Evaluation", card2_desc: "Causal inference (IV, DiD, RDD, Synthetic Control) applied to public-policy questions, the core toolkit behind economic consulting and policy evaluation.",
    card1_tag: "01", card1_title: "Macroeconomics & Country Risk", card1_desc: "Macro and sovereign-risk analysis: inflation, fiscal sustainability, country risk, public finance, regulation.",
    ...
    work_eyebrow: "Recent work", work_title: "Recent research & articles", work_view: "View all",
    ...
    cv_hero_sub: "Education, appointments, research, working papers and skills — the complete record, kept current.",
    ...
    cv_fact_teaching: "Teaching Assistant (Microeconomics & Macroeconomics), Université Paris 2 Panthéon-Assas",
  ...
  ar: {
    ...
    nav_publications: "الأبحاث", nav_articles: "مقالات", nav_cv: "السيرة الذاتية", nav_contact: "تواصل",
    hero_eyebrow: "اقتصادي",
    hero_role: "باحث شاب في الاقتصاد",
    hero_title_1: "محمد براء", hero_title_2: "اللافي",
    hero_lead: "باحث شاب في الاقتصاد، يدرس حاليًا في مدرسة باريس للاقتصاد. تتمحور أعمالي حول الاقتصاد الكلي، والمؤسسات، والتنمية والسياسات العامة.",
    hero_cta_1: "مشاهدة أبحاثي", hero_cta_2: "تواصل معي",
    quote_text: "«لا تكمن الصعوبة في الأفكار الجديدة، بل في التحرر من الأفكار القديمة.»",
    quote_cite: "جون ماينارد كينز",
    stat_1: "أبحاث وأوراق عمل", stat_2: "مقالات منشورة", stat_3: "سنوات من البحث", stat_4: "اللغات المتحدثة",
    ...
    work_eyebrow: "أعمال حديثة", work_title: "أحدث الأبحاث والمقالات", work_view: "عرض الكل",
    ...
    page_pub_title: "الأبحاث", page_pub_sub: "مقالات محكّمة، أوراق عمل، وملاحظات بحثية.",
    ...
    cv_hero_sub: "التكوين والمسار المهني والأبحاث وأوراق العمل والمهارات — السجل الكامل، محدّث باستمرار.",
    ...
    cv_fact_teaching: "مساعد تدريس (الاقتصاد الجزئي والكلي)، جامعة باريس 2 بانتيون-أساس",
